  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl items-center px-4 py-16 sm:px-6 lg:px-8">
      <section className="w-full rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm">
        <h1 className="font-display text-4xl font-bold tracking-tight text-slate-950">Page Not Found</h1>
        <p className="mt-4 text-base leading-7 text-slate-600">The page you requested is not available. Please continue from the main navigation.</p>
